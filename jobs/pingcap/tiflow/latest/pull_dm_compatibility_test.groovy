...
pipelineJob('pingcap/tiflow/pull_dm_compatibility_test') {
    logRotator {
        daysToKeep(30)
    }
    parameters {
        ...
        pipelineTriggers {
            triggers {
                ghprbTrigger {
                    ...
                    triggerPhrase('.*/(debug-dm-compatibility-test.*)')
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext("debug-ci/dm-compatibility-test")
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath("pipelines/pingcap/tiflow/latest/pull_dm_compatibility_test.groovy")
            scm {
                git{
                    remote {
