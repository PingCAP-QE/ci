...
pipelineJob('pingcap/tiflow/pull_dm_integration_test') {
    logRotator {
        daysToKeep(30)
    }
    parameters {
            ...
            triggers {
                ghprbTrigger {
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext("debug-ci/dm-integration-test")
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath("pipelines/pingcap/tiflow/latest/pull_dm_integration_test.groovy")
            scm {
                git{
                    remote {
