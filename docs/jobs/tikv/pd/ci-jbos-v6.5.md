...
| --------------------------------------------------------------------------------------- | ------------------------------------------- | --------------------- | --------------------------------------------------------------------- | ---------------------------------- | ------------------------------------------------ | -------------------------- |
| [ghpr_build](/jenkins/jobs/tikv/pd/release-6.5/ghpr_build/dsl.groovy)                                                       | lint check and build binary.                | `/test build`         | [link](/jenkins/jobs/tikv/pd/release-6.5/ghpr_build/Jenkinsfile)              | yes                                | run `make` and `WITH_RACE=1 make`                | 4 core cpu, 8GB memory     |
