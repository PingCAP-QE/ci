...
| ------------------------------------------------------------------- | ----------------------------------------- | --------------------- | ------------------------------------------------------------- | ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ghpr_build](/jenkins/jobs/pingcap/tidb/latest/ghpr_build/dsl.groovy)           | lint check and build binary.              | `/test build`         | [link](/jenkins/jobs/pingcap/tidb/latest/ghpr_build/Jenkinsfile)      | yes                                | run `make bazel_build`                                                                                                                                                                                                                                                                         |
| [ghpr-unit-test](/jenkins/jobs/pingcap/tidb/latest/ghpr_unit_test/dsl.groovy)   | Unit/Func tests                           | `/test unit-test`     | [link](/jenkins/jobs/pingcap/tidb/latest/ghpr_unit_test/Jenkinsfile)  | yes                                | run `make bazel_coverage_test`                                                                                                                                                                                                                                                                 | yes |
| [ghpr-check-dev](/jenkins/jobs/pingcap/tidb/latest/ghpr_check/dsl.groovy)       | More static checks.                       | `/test check-dev`     | [link](/jenkins/jobs/pingcap/tidb/latest/ghpr_check/Jenkinsfile)      | yes                                | run `make gogenerate check integrationtest`                                                                                                                                                                                                                                                        |
| [ghpr-check-dev2](/jenkins/jobs/pingcap/tidb/latest/ghpr_check2/dsl.groovy)     | Basic function tests                      | `/test check-dev2`    | [link](/jenkins/jobs/pingcap/tidb/latest/ghpr_check2/Jenkinsfile)     | yes                                | Add component binaries `tikv-server` and `pd-server` to the `bin/` dir after `make bazel_build`, then run the scripts in `scripts/pingcap/tidb` folder of  `pingcap-qe/ci` repo, [detail](https://github.com/PingCAP-QE/ci/blob/main/jenkins/jobs/pingcap/tidb/latest/ghpr_check2/Jenkinsfile#L79-L86) |
| [ghpr-mysql-test](/jenkins/jobs/pingcap/tidb/latest/ghpr_mysql_test/dsl.groovy) | Test for compatibility for mysql protocol | `/test mysql-test`    | [link](/jenkins/jobs/pingcap/tidb/latest/ghpr_mysql_test/Jenkinsfile) | no                                 | 🔒test repo(PingCAP-QE/tidb-test) not public                                                                                                                                                                                                                                                       |
...
| merged_integration_br_test     | Integration test for backup and restore functions                 | yes              | merged_integration_br_test.groovy     | Run case with `tests/run.sh` shell, [the case list](https://github.com/PingCAP-QE/ci/blob/main/jenkins/jobs/pingcap/tidb/latest/merged_integration_br_test/Jenkinsfile#L94~L112).                                                              | yes                                | N/A                             |
| merged_integration_cdc_test    | Integration test with TiCDC                                       | yes              | merged_integration_cdc_test.groovy    | Run case with make task in pingcap/tiflow repo: `make integration_test_mysql CASE="${CASES}"`, [the case list](https://github.com/PingCAP-QE/ci/blob/main/jenkins/jobs/pingcap/tidb/latest/merged_integration_cdc_test/Jenkinsfile#L132~L143). | yes                                | N/A                             |
