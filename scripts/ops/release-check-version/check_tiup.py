...
def check_tiup_component_exists(component, version, is_tiup_staging):
    check_result = True
    check_detail = []
    tiup_mirror = os.environ.get("TIUP_MIRROR_URL", "https://tiup-mirrors.pingcap.com")
    if is_tiup_staging:
        tiup_mirror = os.environ.get("TIUP_STAGING_MIRROR_URL", "http://tiup.pingcap.net:8988")
