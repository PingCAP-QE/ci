...
# Usage: 
#   ./ticdc_download_test_binaries_by_tag.sh <version> [components...] [--os=<os>] [--arch=<arch>]
# Example:
#   ./ticdc_download_test_binaries_by_tag.sh v8.1.0 tidb pd             # download tidb and pd for linux/amd64
#   ./ticdc_download_test_binaries_by_tag.sh v8.1.0                     # download all for linux/amd64
#   ./ticdc_download_test_binaries_by_tag.sh v8.1.0 --os=darwin --arch=arm64 tidb  # specify os/arch
