    ...
    node('delivery') {
        container("delivery") {
            ...
            stage('download') {
                ...
                dir('etcd') {
                    sh "curl -L ${FILE_SERVER_URL}/download/pingcap/etcd-v3.4.30-linux-amd64.tar.gz | tar xz"
                    sh "curl -L ${FILE_SERVER_URL}/download/pingcap/etcd-v3.4.30-linux-arm64.tar.gz | tar xz"
                }
            }
                ...
                def push_bin = { target ->
                    dir("${target}") {
                        sh """
                           ...
                           cp ${ws}/etcd/etcd-v3.4.30-linux-amd64/etcdctl ./bin
                ...
                def push_arm_bin = { target ->
                    dir("${target}") {
                        sh """
                           ...
                           cp ${ws}/etcd/etcd-v3.4.30-linux-arm64/etcdctl ./bin
