    ...
    node('delivery') {
        container("delivery") {
            ...
            stage('download') {
                ...
                dir('etcd') {
                    sh "curl -C - --retry 3 -L ${FILE_SERVER_URL}/download/pingcap/etcd-v3.3.10-linux-amd64.tar.gz | tar xz"
                    sh "curl -C - --retry 3 -L ${FILE_SERVER_URL}/download/pingcap/etcd-v3.3.10-linux-arm64.tar.gz | tar xz"
                }
            }
