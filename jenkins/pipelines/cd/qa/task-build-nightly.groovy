    ...
    stage('Build') {
        try {
            parallel(
                ...
                "tikv-release-5.0-rc": {
                    build(job: "build-tikv", parameters: [string(name: "BRANCH", value: "release-5.0-rc"), string(name: "MAKE_TARGET", value: "dist_release")])
                    build(job: "build-tikv", parameters: [string(name: "BRANCH", value: "release-5.0-rc"), string(name: "MAKE_TARGET", value: "fail_release")])
                },
                "tikv-release-5.0": {
                ...
                "pd-all-releases": {
                    for (branch in ["release-3.0", "release-3.1", "release-4.0", "release-5.0-rc", "release-5.0", "master"]) {
                        try {
                            ...
                            if (["release-4.0", "release-5.0", "master"].contains(branch)) {
