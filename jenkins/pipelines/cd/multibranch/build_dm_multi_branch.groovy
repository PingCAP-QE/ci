        ...
        stage("Upload dm-ansible") {
            dir(build_path) {
                container("golang") {
                    ...
                    curl --fail -F ${refspath}=@dm-ansible-sha1 ${FILE_SERVER_URL}/upload | egrep '"status":\\s*true\\b' 
                    ...
                    curl --fail -F ${filepath}=@dm-ansible.tar.gz ${FILE_SERVER_URL}/upload | egrep '"status":\\s*true\\b'
                    """
                }
            }
        }
