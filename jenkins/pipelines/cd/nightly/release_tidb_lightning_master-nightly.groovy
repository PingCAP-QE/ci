...
catchError {
    node('delivery') {
        container("delivery") {
            ...
            """
                dir ('centos7') {
                    tidb_lightning_sha1 = sh(returnStdout: true, script: "curl ${FILE_SERVER_URL}/download/refs/pingcap/br/${TIDB_LIGHTNING_BRANCH}/sha1").trim()
                    sh "curl ${FILE_SERVER_URL}/download/builds/pingcap/br/${TIDB_LIGHTNING_BRANCH}/${tidb_lightning_sha1}/centos7/br.tar.gz | tar xz"
