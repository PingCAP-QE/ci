...
def clone_server_package = { arch, dst ->
    ...
    --blackbox_exporter v0.12.0 --prometheus $VERSION --node_exporter v0.17.0 --dm v1.9.2 \
...
def clone_toolkit_package = { arch, dst ->
    ...
    --dm-master $VERSION --dmctl $VERSION --br $VERSION --spark v2.4.3 \
...
def package_tools = { plat, arch ->
    ...
    sh """
        ...
        cp etcd/etcd-v3.3.10-linux-${arch}/etcdctl ${toolkit_dir}/
