...
def download = { name, version, os, arch ->
    ...
    sh """
    curl -C - -f --retry 3 ${FILE_SERVER_URL}/download/builds/pingcap/${name}/${dm_sha1}/${platform}/${tarball_name} | tar xz
    curl -C - -f --retry 3 ${FILE_SERVER_URL}/download/builds/pingcap/${name}/${dm_sha1}/${platform}/dm-ansible.tar.gz | tar xz
    """
}
