...
def ifFileCacheExists(product,hash,binary) {
    ...
    if (product == "importer") {
        filepath = "builds/pingcap/${product}/optimization/${hash}/darwin/${product}.tar.gz"
    }
    if (product == "tiflash") {
        filepath = "builds/pingcap/${product}/optimization/${RELEASE_TAG}/${hash}/darwin/${product}.tar.gz"
    }  
    if (product=="tikv"){
        filepath = "builds/pingcap/${product}/optimization/${hash}/darwin/${binary}.tar.gz"
    }
