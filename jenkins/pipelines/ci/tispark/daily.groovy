                    ...
                    test1: {
                        ...
                        build(job: "tispark_ghpr_integration_test",
                                parameters: [
                                        ...
                                        string(name: 'ghprbCommentBody', value: "tidb=master pd=master tiflash=master tikv=master profile=3.0  test-spark-catalog=yes"),
                                ],
                    ...
                    test3: {
                        ...
                        build(job: "tispark_ghpr_integration_test",
                                parameters: [
                                        ...
                                        booleanParam(name: 'daily_test', value: true),
                                        string(name: 'ghprbActualCommit', value: commitID),
                                        string(name: 'ghprbCommentBody', value: "tidb=master pd=master tiflash=master tikv=master profile=3.1  test-spark-catalog=yes"),
                                ],
                                wait: true, propagate: true)
                    },
