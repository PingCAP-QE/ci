...
//                        release stage 只编译 tikv 和 importer
        ...
        container("delivery") {
            ...
            stage('download') {
                dir('centos7') {
                    ...
                    sh "curl ${FILE_SERVER_URL}/download/builds/pingcap/mydumper/optimization/${mydumper_sha1}/centos7/mydumper-linux-amd64.tar.gz | tar xz"
