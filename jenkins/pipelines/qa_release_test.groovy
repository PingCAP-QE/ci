...
//                一些集成测试需要集群环境测试，依赖的其他组件有通过 refs/pingcap/xx/${branch}/sha1 找 ref 的逻辑，在这里兼容上传
                    ...
                    sh "inv upload --force --dst builds/pingcap/tidb/${release_info.release_branch}/${release_info.tidb_commit}/centos7/tidb-server.tar.gz 
                    ...
                    sh "inv upload --force --dst download/builds/pingcap/pd/${release_info.release_branch}/${release_info.pd_commit}/centos7/pd-server.tar.gz
                    ...
                    sh "inv upload --force --dst download/builds/pingcap/tikv/${release_info.release_branch}/${release_info.tikv_commit}/centos7/tikv-server.tar.gz
