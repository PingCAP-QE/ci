...
pipelineJob('cdc_ghpr_test') {
        ...
        pipelineTriggers {
            triggers {
                ghprbTrigger {
                    ...
                    triggerPhrase('(.*/run(-all-tests|-unit-test).*)|(/merge)')
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext("idc-jenkins-ci-ticdc/unit-test")
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath("jenkins/pipelines/ci/ticdc/cdc_ghpr_test.groovy")
            scm {
                git{
                    remote {
