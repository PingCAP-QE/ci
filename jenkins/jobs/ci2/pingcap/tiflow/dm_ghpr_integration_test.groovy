...
pipelineJob('dm_ghpr_integration_test') {
        ...
        pipelineTriggers {
            triggers {
                ghprbTrigger {
                    ...
                    triggerPhrase('(.*/run(-all-tests|-dm-integration-tests?).*)|(/merge)')
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext("idc-jenkins-ci-ticdc/dm-integration-test")
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath("jenkins/pipelines/ci/ticdc/dm_ghpr_integration_test.groovy")
            scm {
                git{
                    remote {
