...
pipelineJob('engine_ghpr_integration_test') {
        ...
        pipelineTriggers {
            triggers {
                ghprbTrigger {
                    ...
                    triggerPhrase('(.*/run(-all-tests|-engine-integration-test).*)|(/merge)')
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext("tiflow/engine-integration-test")
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath("jenkins/pipelines/ci/ticdc/engine_ghpr_integration_test.groovy")
            scm {
                git{
                    remote {
