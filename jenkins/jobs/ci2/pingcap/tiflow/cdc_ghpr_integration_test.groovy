...
pipelineJob('cdc_ghpr_integration_test') {
    logRotator {
        daysToKeep(90)
    }
    parameters {
            ...
            triggers {
                ghprbTrigger {
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext("idc-jenkins-ci-ticdc/integration-test")
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath("jenkins/pipelines/ci/ticdc/cdc_ghpr_integration_test.groovy")
            scm {
                git{
                    remote {
