...
pipelineJob('binlog_ghpr_build_new3') {
    disabled(true)
    logRotator {
        daysToKeep(30)
    }
            ...
            triggers {
                ghprbTrigger {
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext("idc-jenkins-ci-binlog/build")
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath("jenkins/pipelines/ci/tidb-binlog/binlog_ghpr_build_new3.groovy")
            scm {
                git{
                    remote {
