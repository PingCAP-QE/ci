...
pipelineJob('binlog_ghpr_unit_test') {
    disabled(true)
    logRotator {
        daysToKeep(30)
    }
            ...
            triggers {
                ghprbTrigger {
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext("idc-jenkins-ci-tidb-binlog/unit-test")
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath("jenkins/pipelines/ci/tidb-binlog/binlog_ghpr_unit_test.groovy")
            scm {
                git{
                    remote {
