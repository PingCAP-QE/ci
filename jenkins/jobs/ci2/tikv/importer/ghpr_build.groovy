...
pipelineJob('importer_ghpr_build') {
    logRotator {
        daysToKeep(90)
    }
    parameters {
            ...
            triggers {
                ghprbTrigger {
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext("idc-jenkins-ci-importer/build")
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath("jenkins/pipelines/ci/importer/importer_ghpr_build.groovy")
            scm {
                git{
                    remote {
