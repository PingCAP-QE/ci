...
pipelineJob('tiflash_ghpr_build_release') {
        ...
        pipelineTriggers {
            triggers {
                ghprbTrigger {
                    ...
                    triggerPhrase('.*/(run-build-release.*)')
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext('idc-jenkins-ci-tiflash/build-release')
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath('jenkins/pipelines/ci/tiflash/tiflash_ghpr_build_release.groovy')
            scm {
                git{
                    remote {
