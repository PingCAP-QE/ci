...
pipelineJob('tidb_ghpr_integration_common_test') {
    disabled(true)
    logRotator {
        daysToKeep(30)
    }
        ...
        pipelineTriggers {
            triggers {
                ghprbTrigger {
                    ...
                    triggerPhrase('.*/(run(-integration-tests|-integration-common-test).*)')
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext('idc-jenkins-ci-tidb/integration-common-test')
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath('jenkins/pipelines/ci/tidb/tidb_ghpr_integration_common_test.groovy')
            scm {
                git{
                    remote {
