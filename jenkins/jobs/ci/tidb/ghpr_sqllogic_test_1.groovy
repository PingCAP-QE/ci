...
pipelineJob('tidb_ghpr_sqllogic_test_1') {
    logRotator {
        daysToKeep(30)
    }
    parameters {
            ...
            triggers {
                ghprbTrigger {
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext('idc-jenkins-ci-tidb/sqllogic-test-1')
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath('jenkins/pipelines/ci/tidb/tidb_ghpr_sqllogic_test_1.groovy')
            scm {
                git{
                    remote {
