...
pipelineJob('tidb_ghpr_sqllogic_test_2') {
    disabled(true)
    logRotator {
        daysToKeep(30)
    }
            ...
            triggers {
                ghprbTrigger {
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext('idc-jenkins-ci-tidb/sqllogic-test-2')
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath('jenkins/pipelines/ci/tidb/tidb_ghpr_sqllogic_test_2.groovy')
            scm {
                git{
                    remote {
