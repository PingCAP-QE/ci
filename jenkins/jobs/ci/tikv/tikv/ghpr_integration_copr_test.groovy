...
pipelineJob('tikv_ghpr_integration-copr-test') {
        ...
        pipelineTriggers {
            triggers {
                ghprbTrigger {
                    ...
                    triggerPhrase('.*/(run-integration-tests|run-integration-copr-test).*')
                    ...
                    extensions {
                        ...
                        ghprbSimpleStatus {
                            commitStatusContext('idc-jenkins-ci-tikv/integration-copr-test')
    ...
    definition {
        cpsScm {
            lightweight(true)
            scriptPath('jenkins/pipelines/ci/tikv/tikv_ghpr_integration-copr-test.groovy')
            scm {
                git{
                    remote {
