...
final K8S_NAMESPACE = "jenkins-tiflash-schrodinger"
            ...
            post {
                always {
                    dir(REFS.repo) {
                        sh '''
                            set +e
                            out_dir="artifacts/tiflash-schrodinger-logs"
                            mkdir -p "${out_dir}"
                            ...
                            tar -czf artifacts/tiflash-schrodinger-logs.tar.gz -C artifacts tiflash-schrodinger-logs || true
                        '''
