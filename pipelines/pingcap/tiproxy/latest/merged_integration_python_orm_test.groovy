...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tiproxy/latest/pod-merged_integration_python_orm_test.yaml'
    ...
    stages {
        ...
        stage('Tests') {
            matrix {
                ...
                stages {
                    stage("Test") {
                        when { expression { return !matrixCache.shouldSkip(REFS, 'Test', [test_cmds: env.TEST_CMDS]) } }
