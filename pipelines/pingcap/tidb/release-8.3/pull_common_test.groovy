...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tidb/release-8.3/pod-pull_common_test.yaml'
    ...
    stages {
        ...
        stage('Tests') {
            matrix {
                ...
                stages {
                    stage("Test") {
                        when { expression { return !matrixCache.shouldSkip(REFS, 'Test', [test_dir: env.TEST_DIR, test_cmd: env.TEST_CMD]) } }
