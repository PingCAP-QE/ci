...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tidb/release-6.5-20241101-v6.5.7/pod-pull_integration_mysql_test.yaml'
    ...
    stages {
        ...
        stage('Tests') {
            matrix {
                ...
                stages {
                    stage("Test") {
                        when { expression { return !matrixCache.shouldSkip(REFS, 'Test', [test_part: env.TEST_PART, test_store: env.TEST_STORE]) } }
