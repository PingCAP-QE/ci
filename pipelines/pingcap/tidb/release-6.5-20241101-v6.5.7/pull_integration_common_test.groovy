...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tidb/release-6.5-20241101-v6.5.7/pod-pull_integration_common_test.yaml'
    ...
    stages {
        ...
        stage('Tests') {
            matrix {
                ...
                stages {
                    stage("Test") {
                        when { expression { return !matrixCache.shouldSkip(REFS, 'Test', [test_dir: env.TEST_DIR, test_store: env.TEST_STORE]) } }
