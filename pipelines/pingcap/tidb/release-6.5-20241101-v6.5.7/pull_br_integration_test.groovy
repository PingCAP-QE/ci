...
// should triggerd for release-6.5-20241101-v6.5.7 branches
@Library('tipipeline') _

final K8S_NAMESPACE = "jenkins-tidb"
final GIT_FULL_REPO_NAME = 'pingcap/tidb'
final GIT_CREDENTIALS_ID = 'github-sre-bot-ssh'
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tidb/release-6.5-20241101-v6.5.7/pod-pull_br_integration_test.yaml'
                ...
                dir("third_party_download") {
                    retry(2) {
                        sh label: "download third_party", script: """
                            ...
                            ${WORKSPACE}/scripts/pingcap/tidb/br_integration_test_download_dependency.sh release-6.5-20241101-v6.5.7
