...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tidb/release-8.1/pod-pull_lightning_integration_test.yaml'
                ...
                dir("third_party_download") {
                    retry(2) {
                        sh label: "download third_party", script: """
                            ...
                            ${WORKSPACE}/tidb/lightning/tests/download_integration_test_binaries.sh release-8.1
