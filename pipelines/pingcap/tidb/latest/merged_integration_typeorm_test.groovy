...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tidb/latest/pod-merged_integration_typeorm_test.yaml'
...
pipeline {
    ...
    stages {
        ...
        stage('Prepare') {
            steps {
                dir('tidb') {
                    cache(path: "./bin", filter: '**/*', key: "binary/pingcap/tidb/merged_integration_typeorm_test/rev-${BUILD_TAG}") {
                        container("golang") {
