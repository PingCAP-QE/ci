...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tidb/release-9.0-beta/pod-pull_integration_nodejs_test.yaml'
    ...
    stages {
        ...
        stage('Node.js Tests') {
            matrix {
                ...
                stages {
                    stage("Test") {
                        when { expression { return !matrixCache.shouldSkip(REFS, 'Test', [test_dir: env.TEST_DIR]) } }
