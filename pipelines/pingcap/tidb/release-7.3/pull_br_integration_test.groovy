...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tidb/release-7.3/pod-pull_br_integration_test.yaml'
                ...
                dir("third_party_download") {
                    retry(2) {
                        sh label: "download third_party", script: """
                            ...
                            ${WORKSPACE}/tidb/br/tests/download_integration_test_binaries.sh release-7.3
