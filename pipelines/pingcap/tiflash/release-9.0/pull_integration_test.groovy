...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tiflash/release-9.0/pod-pull_build.yaml'
final POD_INTEGRATIONTEST_TEMPLATE_FILE = 'pipelines/pingcap/tiflash/release-9.0/pod-pull_integration_test.yaml'
