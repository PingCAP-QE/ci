...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tiflash/latest/pod-merged_unit-test.yaml'
    ...
    stages {
        ...
        stage('Checkout') {
            ...
            steps {
                dir("tiflash") {
                    script {
                        // NOTE: cp cached code to workspace to avoid git submodule update take too much time.
                        // delete this after we have a better solution.
                        // sh """
