...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tiflash/release-7.1/pod-pull_build.yaml'
final POD_INTEGRATIONTEST_TEMPLATE_FILE = 'pipelines/pingcap/tiflash/release-7.1/pod-pull_integration_test.yaml'
                            ...
                            dir("${WORKSPACE}/tiflash") {
                                cache(path: "./", includes: '**/*', key: "ws/pull-tiflash-integration-tests/${BUILD_TAG}") {
                                    ...
                                    dir("tests/${TEST_PATH}") {
                                        ...
                                        script {
                                            def pdBranch = component.computeArtifactOciTagFromPR('pd', REFS.base_ref, REFS.pulls[0].title, 'release-7.1')
                                            def tikvBranch = component.computeArtifactOciTagFromPR('tikv', REFS.base_ref, REFS.pulls[0].title, 'release-7.1')
                                            def tidbBranch = component.computeArtifactOciTagFromPR('tidb', REFS.base_ref, REFS.pulls[0].title, 'release-7.1')
