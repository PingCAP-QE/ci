...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tiflow/release-5.3/pod-pull_dm_integration_test.yaml'
                ...
                dir("third_party_download") {
                    retry(2) {
                        sh label: "download third_party", script: """
                            chmod +x ../scripts/pingcap/tiflow/release-5.3/dm_download_integration_test_binaries.sh
                            cp ../scripts/pingcap/tiflow/release-5.3/dm_download_integration_test_binaries.sh ../tiflow/dm/tests/
                            ...
                            dir('tiflow') {
                                cache(path: "./", includes: '**/*', key: "ws/${BUILD_TAG}/tiflow-dm") {
                                    ...
                                    sh label: "${TEST_GROUP}", script: """
                                        chmod +x ../scripts/pingcap/tiflow/release-5.3/dm_run_group.sh
                                        cp ../scripts/pingcap/tiflow/release-5.3/dm_run_group.sh dm/tests/
