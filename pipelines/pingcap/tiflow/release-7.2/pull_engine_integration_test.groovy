...
// should triggerd for master and release-7.2 release branches
...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tiflow/release-7.2/pod-pull_engine_integration_test.yaml'
                            ...
                            dir('tiflow') {
                                cache(path: "./", filter: '**/*', key: prow.getCacheKey('git', REFS)) {
                                    ...
                                    sh label: "prepare image", script: """
                                        TIDB_CLUSTER_BRANCH=release-7.2
