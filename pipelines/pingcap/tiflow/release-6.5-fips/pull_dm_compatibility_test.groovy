...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tiflow/release-6.5-fips/pod-pull_dm_compatibility_test.yaml'
                ...
                dir("tiflow") {
                        retry(2) {
                            ...
                            sh label: "download third_party", script: """
                                chmod +x ../scripts/pingcap/tiflow/release-6.5-fips/dm_download_compatibility_test_binaries.sh
                                cp ../scripts/pingcap/tiflow/release-6.5-fips/dm_download_compatibility_test_binaries.sh dm/tests/
