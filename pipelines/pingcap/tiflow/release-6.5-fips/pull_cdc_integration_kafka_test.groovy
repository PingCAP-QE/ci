...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tiflow/release-6.5-fips/pod-pull_cdc_integration_kafka_test.yaml'
                ...
                dir("third_party_download") {
                    retry(2) {
                        sh label: "download third_party", script: """
                            cd ../tiflow
                            chmod +x ../scripts/pingcap/tiflow/release-6.5-fips/ticdc_download_integration_test_binaries.sh
                            ${WORKSPACE}/scripts/pingcap/tiflow/release-6.5-fips/ticdc_download_integration_test_binaries.sh
                            ls -alh ./bin/
