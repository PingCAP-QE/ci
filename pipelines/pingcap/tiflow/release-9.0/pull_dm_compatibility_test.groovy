...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tiflow/release-9.0/pod-pull_dm_compatibility_test.yaml'
                            ...
                            script {
                                ...
                                sh label: "download third_party", script: """
                                    if [[ "${branchInfo.isHotfix}" == "true" ]]; then
                                        ...
                                        cd dm/tests && ./download-compatibility-test-binaries.sh release-9.0
