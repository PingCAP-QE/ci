...
final POD_TEMPLATE_FILE = 'pipelines/pingcap/tiflow/release-6.1/pod-pull_dm_integration_test.yaml'
                            ...
                            dir('tiflow') {
                                cache(path: "./", includes: '**/*', key: "ws/${BUILD_TAG}/tiflow-dm") {
                                    ...
                                    sh label: "${TEST_GROUP}", script: """
                                        chmod +x ../scripts/pingcap/tiflow/release-6.1/dm_run_group.sh
                                        cp ../scripts/pingcap/tiflow/release-6.1/dm_run_group.sh dm/tests/
